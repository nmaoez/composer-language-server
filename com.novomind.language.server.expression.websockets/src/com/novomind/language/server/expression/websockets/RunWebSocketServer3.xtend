package com.novomind.language.server.expression.websockets
...
class RunWebSocketServer3 {
	...
	def static void main(String[] args) {
		...
		var ExpressionWebSocketServer server = new ExpressionWebSocketServer(new InetSocketAddress(host, port)) {
...
class ExpressionWebSocketServer extends WebSocketServer {
